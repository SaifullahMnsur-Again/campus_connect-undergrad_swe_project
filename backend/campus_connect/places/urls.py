...
from .views import (
    ...
    PlaceUpdateDetailView, PlaceUpdateApprovalView, PlaceRecursiveDeleteView
)
...
urlpatterns = [
    ...
    path('<int:pk>/recursive-delete/', PlaceRecursiveDeleteView.as_view(), name='place-recursive-delete'),
